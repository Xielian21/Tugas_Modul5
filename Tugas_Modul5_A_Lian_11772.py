...
if os.path.exists(model_path):
    try:
        ...
        def preprocess_image(image):
            ...
            image_array = image_array.flatten().reshape(1, -1)  # Ratakan dan sesuaikan dimensi
            return image_array

        st.title("Fashion MNIST Image Classifier - 1772")
        st.write("Unggah beberapa gambar item fashion (misalnya sepatu, tas, baju), dan model akan memprediksi kelasnya.")
    ...
    st.error("File model tidak ditemukan. Pastikan file 'best_model.pkl' ada di path yang benar.")
